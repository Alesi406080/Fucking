# Decompiled By Sahil
# Github : https://github.com/Alesi406080
# Decompile by Shahid:)
# with (uncompyle6) version : 4.7.4
# Time Succes decompile : 2022-06-05 15:47:11.403269
...
ua_Infinix    = 'Mozilla/5.0 (Linux; Android 5.0; ASUS_Z00AD Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/37.0.0.0 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
...
####LOGO####
            """
    print("\n%s    _________ __     \n%s   / ____/ (_) /____  ║ %sDesign By %sSahil %s& %sAlex\n%s  / __/ / / / __/ _ \ ║ %sFB %s: %sFacebook.com/03081008587sahil\n%s / /___/ / / /_/  __/ ║ %sWt%s: %s03081008587/\n%s/_____/_/_/\__/\___/  ║ %sGithub %s: %sGithub.com/Alesi406080\n"%(O,O,P,O,P,O,O,P,O,P,O,P,O,P,O,P,O,P))
                                      """
def menu_log():
    ...
    if pmu in ['']:
        ...
        if pf in ['']:
            ...
            os.system('xdg-open https://facebook.com/03081008587sahil')
